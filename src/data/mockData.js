...
export const maintenanceData = [
  {
    ...
    technician: "박기술",
    technicianContact: "010-1234-5678",
    cost: "150000",
    notes: "램프 교체 및 광학장치 청소 완료",
    workDetails:
      "램프 교체(모델명: EPSON ELPLP49), 광학장치 먼지 제거, 냉각팬 점검",
  },
  {
    id: 2,
    assetId: "AST-002",
    ...
    technician: "이수리",
    technicianContact: "010-2345-6789",
    cost: "220000",
    notes: "토너 카트리지 교체 및 롤러 청소",
    workDetails: "정품 토너 카트리지 교체, 픽업 롤러 청소, 용지 걸림 센서 조정",
  },
  {
    id: 3,
    assetId: "AST-009",
    ...
    completedDate: null,
    technician: "김태블릿",
    technicianContact: "010-3456-7890",
    cost: null,
    notes: "화면 깨짐 수리 중",
    workDetails: null,
  },
  ...
  },
  {
    ...
    completedDate: null,
    technician: "이모바일",
    technicianContact: "010-5678-9012",
    cost: null,
  ...
  },
  {
    ...
    technician: "최가구",
    technicianContact: "010-9876-5432",
    cost: "80000",
    notes: "테이블 상판 스크래치 보수",
    workDetails: "상판 스크래치 부분 샌딩 후 도색 작업 완료",
  },
  {
    id: 7,
    assetId: "AST-008",
    ...
    technicianContact: "010-1234-5678",
    cost: null,
    notes: "클릭 불량 수리 예정이었으나 신규 제품으로 교체 결정",
    workDetails: null,
  },
  {
    id: 8,
    assetId: "AST-006",
    assetName: "LG 울트라와이드 모니터",
    type: "정기점검",
    status: "예정",
    priority: "중간",
...
export const fetchData = {
  ...
  // 유지보수 상세 정보 가져오기 (추가된 함수)
  getMaintenanceById: (id) => {
    const maintenance = maintenanceData.find((item) => item.id === Number(id));
